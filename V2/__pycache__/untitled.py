...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_fmcomms2_source_0_0 = iio.fmcomms2_source_fc32('192.168.3.1', [True, True, True, True], 32768)
        self.iio_fmcomms2_source_0_0.set_len_tag_key('packet_len')
        self.iio_fmcomms2_source_0_0.set_frequency(2400000000)
        ...
        # Connections
        ##################################################
        self.connect((self.iio_fmcomms2_source_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.iio_fmcomms2_source_0, 1), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.iio_fmcomms2_source_0_0, 1), (self.qtgui_time_sink_x_1_0, 1))
        self.connect((self.iio_fmcomms2_source_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))
