...
import sip
import sync_epy_block_0 as epy_block_0  # embedded python block
...
class sync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_1_0.set_y_axis(0, 6.5)
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0.set_max(i, 6.5)
        ...
        self._phase_range = Range(-10, 10, 0.01, 0, 200)
        ...
        self.iio_fmcomms2_source_0 = iio.fmcomms2_source_fc32('192.168.2.1', [True, True, True, True], 32768)
        ...
        self.blocks_phase_shift_1_0 = blocks.phase_shift(4.73, True)
        ...
        self.connect((self.blocks_complex_to_magphase_0_0, 0), (self.blocks_null_sink_0, 1))
        self.connect((self.blocks_complex_to_magphase_0_0, 1), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_complex_to_magphase_0_0, 1), (self.qtgui_time_sink_x_1, 1))
        self.connect((self.blocks_phase_shift_1_0, 0), (self.blocks_complex_to_magphase_0_0, 0))
        self.connect((self.blocks_phase_shift_1_0, 0), (self.qtgui_time_sink_x_0, 1))
        ...
        self.connect((self.iio_fmcomms2_source_0, 0), (self.blocks_complex_to_magphase_0, 0))
        self.connect((self.iio_fmcomms2_source_0, 1), (self.blocks_phase_shift_1_0, 0))
        self.connect((self.iio_fmcomms2_source_0, 0), (self.qtgui_time_sink_x_0, 0))
